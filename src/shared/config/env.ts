...
export const env = {
    apiBaseUrl: resolveEnvValue('VITE_API_BASE_URL', rawEnv.VITE_API_BASE_URL, envSchema.shape.VITE_API_BASE_URL),
    enableMsw: resolveEnvValue('VITE_ENABLE_MSW', rawEnv.VITE_ENABLE_MSW, envSchema.shape.VITE_ENABLE_MSW),
    enableDebug: resolveEnvValue('VITE_ENABLE_DEBUG', rawEnv.VITE_ENABLE_DEBUG, envSchema.shape.VITE_ENABLE_DEBUG),
} as const
