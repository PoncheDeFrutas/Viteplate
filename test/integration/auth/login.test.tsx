...
describe('Login — happy path', () => {
    it('logs in with admin credentials and navigates to dashboard', async () => {
        ...
        // Should navigate to dashboard and show user info
        await waitFor(() => {
    ...
    it('logs in with regular user credentials', async () => {
        const user = userEvent.setup();
        renderApp({ initialPath: '/login' });
